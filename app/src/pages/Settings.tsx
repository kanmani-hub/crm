...
const formLinkFields: { key: SheetLinkKey; label: string; hint: string }[] = [
  ...
  { key: 'dpRegistrationForm', label: 'DP Registration Form Link', hint: 'Link to the Direct Placement Google Form' },
  { key: 'bgvForm', label: 'BGV Form Link', hint: 'Link to the BGV Form (docs.google.com/forms)' },
  { key: 'dpBgvForm', label: 'DP BGV Form Link', hint: 'Link to the Direct Placement BGV Form' },
];
