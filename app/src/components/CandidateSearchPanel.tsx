...
export default function CandidateSearchPanel({
  ...
  return (
    <div className={`relative ${className}`}>
      <div className="grid gap-3 lg:grid-cols-[minmax(360px,1fr)_auto] lg:items-start">
        <div className="relative">
          ...
          {searchQuery && (
            <button
              type="button"
              onClick={() => { clearSearchQuery(); setResultsOpen(false); }}
      ...
      {showResults && (
        <div className="absolute left-0 right-0 top-[calc(100%+8px)] z-40 bg-cc-base-deep border border-cc-gridline rounded shadow-[0_22px_70px_rgba(0,0,0,0.46)] max-h-[420px] overflow-y-auto">
